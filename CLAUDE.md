...
**Last Updated:** 2026-08-07 (Session #41 — P0 optimisation set #1–#5: SWS enforce, markSeen on generation failure, blend source cap 5, synthesis-only retry, token caps 3000, ledger per-post instrumentation)
**Owner:** Felix Okon
