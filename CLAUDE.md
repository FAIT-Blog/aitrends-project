...
**Last Updated:** 2026-07-18 (Session #30 — HF FLUX.1-schnell deprecated by HF Inference API (410), switched default image provider to AI Horde; 109 failed posts reset; Groq fallback notification added; Gemini billing root cause confirmed — old key hit Tier 1 after28-day free trial)
**Owner:** Felix Okon
